(function() {
  ...
  function Modulo5_Tela4Controller($log, $timeout, Game) {
    ...
    if(!vm.game.data.outros.modulo5.tela4.items){
      vm.game.data.outros.modulo5.tela4.items = [
        [true, false]//0
      ]
      vm.game.data.outros.modulo5.tela4.currentItem = [
        0,//0
      ]

      vm.game.data.outros.modulo5.tela4.quiz = [
        /*{
          selected: -1,
          completed: false,
          answer: 1,
      ...
      vm.game.data.outros.modulo5.tela4.texts = [

      ]
    }

    vm.items = vm.game.data.outros.modulo5.tela4.items;
    vm.currentItem = vm.game.data.outros.modulo5.tela4.currentItem;
    vm.quiz = vm.game.data.outros.modulo5.tela4.quiz;
    vm.texts = vm.game.data.outros.modulo5.tela4.texts;
