(function() {
  ...
  function Modulo5_Tela6Controller($log, $timeout, Game) {
    ...
    if(!vm.game.data.outros.modulo5.tela6.items){
      vm.game.data.outros.modulo5.tela6.items = [
        [true, false],//0
      ]
      vm.game.data.outros.modulo5.tela6.currentItem = [
        0,//0
      ]

      vm.game.data.outros.modulo5.tela6.quiz = [
        /*{
          selected: -1,
          completed: false,
          answer: 1,
      ...
      vm.game.data.outros.modulo5.tela6.texts = [

      ]
    }

    vm.items = vm.game.data.outros.modulo5.tela6.items;
    vm.currentItem = vm.game.data.outros.modulo5.tela6.currentItem;
    vm.quiz = vm.game.data.outros.modulo5.tela6.quiz;
    vm.texts = vm.game.data.outros.modulo5.tela6.texts;
